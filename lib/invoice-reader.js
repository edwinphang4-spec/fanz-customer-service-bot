...
const FAMILIES = [
  ...
  { keys: ['fs423', 'fs563', 'fs525', 'fs48', 'fs565n', 'fsseries', 'fs'], family: 'FS', brand: 'fanz' },
...
function normalizeModel(modelText) {
  ...
  for (const f of FAMILIES) {
    if (f.keys.some((k) => norm.includes(k))) {
...
module.exports = { readInvoice, extractInvoice, normalizeModel, isConfigured, FAMILIES };
