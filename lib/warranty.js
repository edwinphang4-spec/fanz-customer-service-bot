...
// ============================================
// ============================================
// 2026-08-04:Fanz 给了官方产品清单(Fanz Product List 2026.xlsx,
// 47 型号 / 144 SKU),上面注释里说的"待 Fanz 书面确认"到此为止 ——
// 这张表**由脚本从该清单生成**,不是手抄,也不再是发票倒推的 provisional 值。
//
// 导入前实测:47 个型号里 33 个判对、13 个返回 unknown(bot 会先问品牌,安全但慢)、
// **1 个判错 —— AXEL16 被判成 fanz,实际是 VIOZ**。判错这一个是会直接给错承诺的:
// 10 年 vs 5 年马达保修。
//
// 品牌归属(Edwin 2026-08-04 确认):
//   VIOZ(马达 5 年)= WINDY MKII / FF425 / FF565 / VETTA / AXEL16
//   其余全部 FANZ(马达 10 年),**包括 V605** —— V605 名字像 VIOZ,但清单里在 FANZ 表。
// ============================================
